"""TapScript -- plain-text music notation that compiles to MIDI and audio.

The public surface is small on purpose::

    from tapscript import compile_text

    result = compile_text(open("song.tap").read(), midi="song.mid", wav="song.wav")
...
def __getattr__(name: str):
    # Imported lazily so `import tapscript` stays cheap for the CLI's fast paths.
