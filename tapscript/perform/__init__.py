...
act, and reports what the result sounds like from wherever you choose to stand.
    ...
    :mod:`.conduct`   one gesture applied coherently to every voice
...
from .conduct import Gesture, parse_gesture
from .profiles import SpeechProfile, profile_for_name, profile_for_program, profile_names
from .solve import Solution, VoiceTiming, analyse, apply_to, format_report
from .stage import (
    FRAME_SCORE,
    Placement,
    Stage,
