# SuperInstance Integration Insights — Plainsong as Unification Layer

## The Discovery

Plainsong isn't being built from scratch. It's the **unification layer** that connects six existing SuperInstance systems into one language.
...
- **Plainsong compiles TO this format**
...
- Plainsong blocks can carry vibe metadata that agents read and respond to
...
- **This IS the clock that Plainsong runs on**
...
- **This IS what tells the fleet which Plainsong jams produced gold**
...
- A Plainsong composition with blanks IS a pheromone trail

## The Integration Architecture

```
Plainsong Source (plain text in markdown)
         │
         ▼
    Parser + AST
         │
...
1. **CoComposer** (Aug 2025) — 5-agent LLM system for collaborative composition. Plainsong can be the shared notation.

2. **MACAT/MACataRT** (Jan 2025) — Musical agent systems for real-time human-AI improvisation. Plainsong can be the composition language.

3. **Quantifying Collective Creativity via Topological Data Analysis** (NeurIPS 2025) — Emergence peaks at 70% shared context + 30% private noise. This is the optimal Plainsong jam ratio.
...
5. **Text-to-Everything DSL compilers** (PLDI 2026) — Semantic-lossless IR that preserves comments and layout for round-tripping. Plainsong → MIDI → DAW → Plainsong.

## The Roadmap

1. **Connect vibe-protocol to Plainsong metadata** — `[resonance: warm, high-tension]` maps to vibe dimensions
