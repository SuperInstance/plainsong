...
class ToolRegistry:
    ...
    def _register_builtins(self) -> None:
        self.add(
            "notation_reference",
            "Read the Plainsong notation reference. Call this before writing notation for the "
        ...
        self.add(
            "write_score",
            "Write Plainsong notation to a .song file. The notation is parsed first and the "
            "result reports any problems, so use this rather than write_file for music.",
            _schema(
                {
                    "path": _string("File to write, ending in .song"),
        ...
        self.add(
            ...
            _schema(
                {
                    "path": _string("A .song file to compile."),
        ...
        self.add(
            ...
            _schema(
                {
                    "path": _string("The .song file to transpose."),
